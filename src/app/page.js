      ...
      >
        ...
        >
          <div className="handle">
            <div className="relative w-[40rem] min-h-[30rem] overflow-scroll overflow-x-hidden max-h-min rounded-xl flex flex-col p-6 bg-white shadow-[0_5px_15px_rgba(0,0,0,0.35)] ">
              <button
